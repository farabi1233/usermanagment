                ...
                <section class="col-lg-12 connectedSortable">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <h4>
                                Edit Service
                                <a class=" btn btn-success float-right" href="{{ route('services.view')}}"> <i class="fa fa-list"></i> Your Service</a>
                                ...
                                <form method="POST" action="{{ route('services.update',$editData->id)}}" id="myForm" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <textarea type="text" name="long_title" class="form-control" id="long_title" rows=15">{{$editData->long_title}}</textarea>
