                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <h4>
                                ...
                                <a class=" btn btn-success float-right" href="{{ route('vissons.view')}}"> <i class="fa fa-plus-circle"></i> Misson list</a>
                        ...
                        <div class="card-body">
                            <div class="tab-content p-0">
                                <!-- Morris chart - Sales -->
                                <form method="POST" action="{{ route('vissons.store')}}" id="myForm" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-row">
