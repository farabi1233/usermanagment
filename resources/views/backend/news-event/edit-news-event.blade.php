                            ...
                            <div class="tab-content p-0">
                                ...
                                <form method="POST" action="{{ route('news_events.update',$editData->id)}}" id="myForm" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="date" class="form-control"  id="datepicker" placeholder="{{$editData->date}}" readonly>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-3">
                                            <img id="showImage"  src="{{(!empty($editData->image))? url('upload/news_event_images/'.$editData->image):url('upload/no_image.jpg') }}" alt="" style="width:150px; height:160px; border: 1px solid black #00">
                                        ...
                                        <div class="form-group col-md-2 " style="padding-top: 60px;">
