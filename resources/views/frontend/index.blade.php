...
<body>
	...
	<section class="header">
		<div class="container">
			<nav class="navbar navbar-expand-md navbar-light">
				<a href="" class="navbar-brand"><img src="{{ asset('forntend/image/logo.png') }}" style="height: 50px;"></a>
	...
	<section class="slider_part">
		<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
		    ...
		    <div class="carousel-inner" role="listbox">
		      ...
		      <div class="carousel-item active" style="background-image: url('forntend/image/slider4.jpeg')">
		      ...
		      <div class="carousel-item" style="background-image: url('forntend/image/slider5.jpg')">
		        <div class="carousel-caption d-none d-md-block">
		      ...
		      <div class="carousel-item" style="background-image: url('forntend/image/slider6.jpg')">
		        <div class="carousel-caption d-none d-md-block">
	...
	<section class="mission_vision">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-6">
					<img src="{{ asset('forntend/image/mission.jpg') }}" style="border: 1px solid #ddd;padding: 5px;background: #EFEE03;border-radius: 30px;float: left;margin-right: 10px;">
				...
				<div class="col-md-6">
					<img src="{{ asset('forntend/image/vision.jpg') }}" style="border: 1px solid #ddd;padding: 5px;background: #EFEE03;border-radius: 30px;float: left;margin-right: 10px;">
					...
					<table class="table table-striped table-bordered table-hover table-md table-warning">
						...
						<tbody>
							<tr>
								<td>1</td>
								<td>24/11/2019</td>
								<td><img src="{{ asset('forntend/image/news1.jpg') }}"></td>
								<td>Dummy content</td>
							...
							<tr>
								<td>2</td>
								<td>25/11/2019</td>
								<td><img src="{{ asset('forntend/image/news2.jpg') }}"></td>
							...
							<tr>
								<td>3</td>
								<td>26/11/2019</td>
								<td><img src="{{ asset('forntend/image/news3.jpg') }}"></td>
